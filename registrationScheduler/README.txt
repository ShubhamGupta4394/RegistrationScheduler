...
ant -buildfile src/build.xml run -Darg0=preference-input.txt -Darg1=regTime.txt -Darg2=output.txt -Darg3=0
...
ArrayList - I have used ArrayList to store Student because it stores element in order, can store objects,
